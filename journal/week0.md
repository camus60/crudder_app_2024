...
### How to generate new User and AWS credentials
...
### Confirm that the AWS CLI is working and that I am the expected user

Type in this command in the bash terminal 
```sh
...
### It is important to enable billing as well
